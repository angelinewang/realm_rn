...
const ProfileCard = ({user}) => {
  ...
  const pickImage = async () => {
    ...
    //TO DO: Add Permissions Request popup before launching image library
    try {
  ...
  //Update photo not in use right now 
  //TO DO: Readd Update Photo function and test to ensure functionality
  ...
  React.useEffect(() => {
    ...
    //Determine age of the user based on the birthdate 
    ...
    //Set the age state to the age calculated
    setAge(finalAge)

    console.log(`Auth User age is ${finalAge}`)

    //Determine the department of the user based on the associated integer
